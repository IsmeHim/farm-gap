CREATE DATABASE IF NOT EXISTS farmgap CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE farmgap;
...
CREATE TABLE IF NOT EXISTS planting_batches (
  ...
  initial_count INT NULL DEFAULT NULL,
  remaining_count INT NULL DEFAULT NULL,
  planting_unit VARCHAR(50) DEFAULT 'ต้น',
  total_damaged_count INT DEFAULT 0,
  total_harvested_count INT DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS pest_logs (
  ...
  damage_cause VARCHAR(100) NULL,
  damage_unit VARCHAR(50) DEFAULT 'ต้น',
  severity VARCHAR(50),
...
CREATE TABLE IF NOT EXISTS harvest_logs (
  ...
  harvested_plants_count INT DEFAULT 0,
  destination VARCHAR(50) DEFAULT 'cold_storage',
  total_packs INT DEFAULT 0,
  stocked_quantity INT DEFAULT 0,
  stock_status VARCHAR(50) DEFAULT 'unstocked',
  product_id INT NULL,
